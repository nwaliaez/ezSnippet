...
const Menu: FC<MenuProps> = ({}) => {
    ...
    return (
        ...
        >
            ...
            <List target='_blank' link="https://www.instagram.com/ezsnippet/" effect="slideUp">
                <Video /> Videos
            </List>
            ...
            <List target='_blank' link="https://www.linkedin.com/in/ezforme/" effect="slideUp">
                <Linkedin color="#0277b5" /> Linkedin
            </List>

            {/* List 3 */}
            <div className="mt-5">Projects</div>
            <List target='_blank' link="https://github.com/nwaliaez/eCommerce" effect="slideUp">
